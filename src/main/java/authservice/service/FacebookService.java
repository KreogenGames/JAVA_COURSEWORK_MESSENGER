...
import authservice.client.FacebookClient;
import authservice.exception.InternalServerException;
import authservice.model.InstaUserDetails;
import authservice.model.Profile;
import authservice.model.Role;
import authservice.model.User;
import authservice.model.facebook.FacebookUser;
    ...
    private User convertTo(FacebookUser facebookUser) {
        return User.builder()
                ...
                .userProfile(Profile.builder()
                        ...
                        .profilePictureUrl(facebookUser.getFacebookPicture().getPictureData().getUrl())
                        .build())
                .build();
    }
